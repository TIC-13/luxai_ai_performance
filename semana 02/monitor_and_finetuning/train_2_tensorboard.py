...
if __name__ == '__main__':
    ...
    valid_loader = torch.utils.data.DataLoader(valid_dataset, batch_size=args.batch_size, 
                                               sshuffle=True, num_workers=args.num_workers, pin_memory=True)
    ...
    for epoch in range(args.epochs):
        ...
        train_loss, train_acc = train_step(model, train_loader, optimizer, criterion, device=DEVICE, logger=writer)
